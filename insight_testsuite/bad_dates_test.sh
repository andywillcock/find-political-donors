...
function compare_outputs {
  ...
  PROJECT_ANSWER_PATH4=${GRADER_ROOT}/temp/output/${OUTPUT_FILENAME}
  TEST_ANSWER_PATH4=${GRADER_ROOT}/tests/${test_folder}/output/${OUTPUT_FILENAME}
...
function run_all_tests {
  ...
  echo "This test checks to see if rows with incorrectly formated dates are ignored"
